...
public abstract class Pokemon {
    ...
    public void alimentar(String comida){
        switch (comida){
            case "Manzana": if (Jugador.getInstancia().getContadorManzanas() >= 1){ //alimentar
                contPeticionComida = 0;
            ...
            case "Cereal":
                if (Jugador.getInstancia().getContadorCereal() >= 1){ //alimentar
                    contPeticionComida = 0;
            ...
            default:
                if (Jugador.getInstancia().getContadorWaffles() >= 1){ //alimentar
                    contPeticionComida = 0;
    ...
    public void curar(String medicina){
        if(contadorEnfermedades > 0){
            switch (medicina){
                case "Vitaminas":
                    if(Jugador.getInstancia().getContadorVitaminas() >= 1){
                ...
                case "Analgesico":
                    if(Jugador.getInstancia().getContadorAnalgesico()>=1){
                ...
                case "Antibiotico":
                    ...
                    if (Jugador.getInstancia().getContadorAntibiotico()>=1){
    ...
    public void necesitaNuevoPaseo(){
        this.contPeticionPaseo += 1;
    }
    ...
    public void necesitaComida() {
        this.contadorComida += 1;
    }
}
